...
// *************
  ...
  // Сохранение в БД.
    $user = 'u41030';
    $pass = '2346324';
    $db = new PDO('mysql:host=localhost;dbname=u41030', $user, $pass, array(PDO::ATTR_PERSISTENT => true));

// Подготовленный запрос. Не именованные метки.
try {
    $stmt = $db->prepare("INSERT INTO users SET name = ?, email = ?, year_of_birth = ?, gender = ?, number_of_limbs = ?, biography = ?");
    $stmt->execute(array(
         $_POST['name'],
         $_POST['email'],
         $_POST['year_of_birth'],
